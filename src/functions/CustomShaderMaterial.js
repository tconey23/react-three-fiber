...
const vertexShader = glsl`
  ...
  void main() {
    vUv = uv;
    vec3 pos = position;
    float displacement = noise(vec3(position * 0.1 + uTime * 0.5));
...
const fragmentShader = glsl`
  ...
  void main() {
    float red = sin(vUv.x * 3.50);
    float green = cos(vUv.y * 0.5843137254901961);
    gl_FragColor = vec4(uColor.r * red, uColor.g * green, uColor.b, 1);
  }
`;
